//COPY of MAIN BACKEND FILE without mongodb changes
...
var mongoDB = 'mongodb+srv://Shivansh770:Shiv770@cluster0.qz1ch.mongodb.net/book-company?retryWrites=true&w=majority';
...
app.get("/author-isbn/:isbn",(req,  res) => {
        ...
        if(getSpecifiAuthors.length===0){
            return res.json({"error": `No Book found for the category of ${isbn}`});
        }
